--Get pick times for all items and the batch they belong to for non PW/PT batches 
SELECT 
x.TaskID, x.PickTaskID, x.SKUID, x.SKUDescription, x.EventTime AS PickTime, x.[Event], x.TaskIDTimeCreated, x.LineItemTimeCreated
